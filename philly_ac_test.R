...
# correlation, and for Geary's C the stat is \in[0,2], where C<1 means 
# positive correlation.
#
# The above tests; therefore, confirm spatial correlation for the probability
# of homicide among all zip codes.  Also, though not reported, all tests are
